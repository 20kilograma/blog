...
Now this is what Path Traversal is, you can read the contents of the files and obtain some sensitive information from the files you shouldn't be able to see, but not execute them. It's like a lower-grade LFI.
