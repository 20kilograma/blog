...
To fix this vulnerability, I would suggest you validate the user input, make sure it's in the expected format, and disable external entity loading. You can disable external entity loading by using the <code>LIBXML_NOENT</code> flag in the <code>loadXML(YOUR_XML, LIBXML_NOENT);</code> function.
