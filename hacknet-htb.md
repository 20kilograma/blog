...
Here, it wasn't the classic case of Jinja2 Template, it was Djangos Own Template Lanaguage, which is very limited of what we can actually do. After quite some time, I found the global <i>users</i> QuerySet Object via this simple payload: <pre><code class="language-none">{{ users }}</code></pre>
