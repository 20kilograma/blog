...
<br>
First thing I was focused on was this <code>is_admin</code> check and thought it may have had maybe something to do with some host headers but it didn't work, later I focused on the whole code<br>
