...
I tried figuring out the hashing algorithm by adding [] to the username/password parameter so I could get an error that it is not an array, I may get some Info like that.<br>
